...
function Home() {
  ...
  return (
    <MainLayout>
      ...
      <section className="max-w-screen-xl mx-auto px-6 py-16 mt-12">
        <h2 className="text-3xl font-bold text-center mb-12 text-white">Media Showcase</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-md rounded-lg overflow-hidden shadow-lg hover:scale-105 transform transition">
            <img src="https://images.ctfassets.net/pdf29us7flmy/69LrnCK7nmkrzMtlqvNSGQ/90fb6628b02769642538f43f8587b416/GettyImages-1142966869-red.jpg?w=720&q=100&fm=jpg" alt="Interview" className="w-full h-56 object-cover" />
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-lg overflow-hidden shadow-lg hover:scale-105 transform transition">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR42wGoDZ68EpjVM7cNjOlKQxO8uk0jfAR89Q&s" alt="Award" className="w-full h-56 object-cover" />
            <div className="p-4 text-center">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-lg overflow-hidden shadow-lg hover:scale-105 transform transition">
            <img src="https://storage.googleapis.com/techsauce-prod/ugc/uploads/2025/5/1748592693_2-GTCTechConference.webp" alt="Conference" className="w-full h-56 object-cover" />
            <div className="p-4 text-center">
      ...
      {/* Join Us Section - Background Updated */}
      <section className="py-16 text-center bg-white/10 backdrop-blur-md rounded-lg max-w-screen-xl mx-auto px-6 mt-12">
        ...
        <a href="/contact" className="bg-white/90 text-blue-600 font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-white transition">
          Join Us
        </a>
      </section>
      ...
      <section className="py-16 text-center bg-white/10 backdrop-blur-md rounded-lg max-w-screen-xl mx-auto px-6 mt-12">
        ...
        <a href="/register" className="bg-white/90 text-blue-600 font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-white transition">
          Get Started
        </a>
      </section>
      ...
      <footer className="bg-gray-900 text-white mt-16">
        <div className="max-w-screen-xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-2">Phone: <a href="tel:+919564148609" className="hover:text-blue-400">+91 9564148609</a></p>
            <p>Email: <a href="mailto:info@qwipo.com" className="hover:text-blue-400">info@qwipo.com</a></p>
          ...
          <div>
            ...
            <a href="/contact" className="inline-block bg-blue-600 hover:bg-blue-500 text-white font-semibold px-6 py-3 rounded-lg shadow-lg transition">
              Contact Us
            </a>
          </div>
        </div>
