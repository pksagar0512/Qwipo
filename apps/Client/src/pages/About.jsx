...
const About = () => {
  ...
  const challenges = [
    ...
    {
      title: "Insufficient resources for sales and marketing management",
      color: "bg-blue-100 text-blue-600",
      icon: "📈",
    },
    {
      title: "Delivery and fulfillment complications and hurdles in logistics",
    ...
    <div className="pt-24 px-6 bg-gray-900 text-white min-h-screen space-y-24">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {challenges.map((challenge, i) => (
            <div
              ...
              className={`bg-gray-800 rounded-3xl p-8 flex flex-col items-center text-center transition-transform duration-300 ${
                hoveredIndex === i ? "shadow-2xl -translate-y-3" : "shadow-lg"
              }`}
              style={{
                boxShadow:
                  hoveredIndex === i
      ...
      <section className="space-y-6 text-center max-w-5xl mx-auto">
        ...
        <img
          ...
          className="w-full max-w-lg mx-auto rounded-3xl shadow-xl transition-transform duration-500 hover:scale-110"
        />
        <p className="text-gray-300 text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 text-gray-300">
          <div className="text-center bg-gray-800 p-6 rounded-3xl shadow-lg">
            <img
              ...
              alt="Siva Morisetti"
              className="w-32 h-32 rounded-full mx-auto shadow-lg transition-transform duration-300 hover:-translate-y-2"
            />
      ...
      <section className="text-center space-y-6 max-w-4xl mx-auto bg-gray-800 py-12 rounded-3xl shadow-xl">
        ...
        <a
          href="/contact"
          className="inline-block bg-emerald-500 text-white px-8 py-3 rounded-full hover:bg-emerald-600 transition font-semibold"
        >
          Reach Out to Us
        </a>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 px-6">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/career" className="hover:text-indigo-400">
                  Career
                </a>
              </li>
              <li>
                <a href="/partners" className="hover:text-indigo-400">
                  Partners
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            >
              Divyasree Trinity, Isprout Co-working Space,
              <br />
              7th Floor, A-Wing, Plot No.5, at Hitech City Layout,
              <br />
              Survey No 64(Part) Madhapur Village,
              <br />
