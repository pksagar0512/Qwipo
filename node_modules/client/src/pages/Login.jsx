...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-900">
      <form onSubmit={handleLogin} className="bg-gray-700 p-8 rounded-lg w-full max-w-md">
        ...
        <button type="submit" className="w-full bg-purple-500 py-2 rounded text-white font-semibold hover:bg-purple-600">Login</button>
